...
Public Class LSystemTreeView
    ...
    Public Overrides Sub OnDraw(drawingSession As CanvasDrawingSession)
        ...
        Dim imageManager = CType(Target.Scene, IObjectWithImageResource).ImageResource
        Dim imageLeaf As CanvasBitmap = DirectCast(imageManager.GetResource(LeafResourceId), CanvasBitmap)
        Dim imageFlower As CanvasBitmap = DirectCast(imageManager.GetResource(FlowerResourceId), CanvasBitmap)
