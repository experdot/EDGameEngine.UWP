...
Public Class SquareCA
    ...
    Public Overrides Sub UpdateEx()
        ...
        For i = 0 To Width - 1
            For j = 0 To Height - 1
                Dim temp As Integer = GetSquareAround(Cells, i, j, Width, Height)
    ...
    ''' 返回正方形网格细胞邻居数量
    ''' </summary>
    Private Function GetSquareAround(ByRef cellArr(,) As ICell, x As Integer, y As Integer, w As Integer, h As Integer) As Integer
