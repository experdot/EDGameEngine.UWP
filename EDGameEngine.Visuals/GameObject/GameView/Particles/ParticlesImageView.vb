...
Public Class ParticlesImageView
    ...
    Public Overrides Sub OnDraw(drawingSession As CanvasDrawingSession)
        Dim imageResource = CType(Target.Scene, IObjectWithImageResource).ImageResource
        Dim image As CanvasBitmap = DirectCast(imageResource.GetResource(ImageResourceId), CanvasBitmap)
