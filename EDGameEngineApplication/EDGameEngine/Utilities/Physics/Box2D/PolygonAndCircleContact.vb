...
Namespace Global.Box2D
    Friend Class PolygonAndCircleContact
        ...
        Friend Overrides Function ComputeTOI(ByRef sweepA As Sweep, ByRef sweepB As Sweep) As Single
            ...
            Return TimeOfImpact.CalculateTimeOfImpact(input, DirectCast(MyBase._fixtureA.GetShape, PolygonShape), DirectCast(MyBase._fixtureB.GetShape, CircleShape))
        End Function
        ...
        Friend Overrides Sub Evaluate()
            ...
            Collision.CollidePolygonAndCircle(Me._manifold, DirectCast(MyBase._fixtureA.GetShape, PolygonShape), form, DirectCast(MyBase._fixtureB.GetShape, CircleShape), form2)
        End Sub
